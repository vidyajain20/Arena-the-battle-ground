...
# print(f'{zombie.get_type_of_enemy()} has {zombie.health_points} health points and cam do attack of {zombie.attack_damage}')
# zombie.talk()
# print(f'{ogre.get_type_of_enemy()} has {ogre.health_points} health points and cam do attack of {ogre.attack_damage}')
# ogre.talk()